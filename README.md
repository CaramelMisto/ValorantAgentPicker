...
## 🛠️ Technologies Used / Teknolojiler
...
1.  Clone the repository / Depoyu klonla:
    ```bash
    git clone [https://github.com/KULLANICIADIN/REPO-ISMI.git](https://github.com/KULLANICIADIN/REPO-ISMI.git)
    ```
2.  Navigate to the folder / Klasöre git.
3.  Open `index.html` in your browser / `index.html` dosyasını tarayıcıda aç.
...
### ⚠️ Disclaimer
*This project is not affiliated with Riot Games. All Valorant assets (images, names) are property of Riot Games.*
